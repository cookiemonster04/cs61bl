...
public class TERenderer {
     ...
     */
    public void renderFrame(TETile[][] world, int coins, String err, boolean toggleSight, int aX, int aY) {
...
//                    world[x][y].draw(x + xOffset, y + yOffset);
        ...
        StdDraw.textLeft(5, Engine.HEIGHT + 1, String.format("Coins: %d", coins));
