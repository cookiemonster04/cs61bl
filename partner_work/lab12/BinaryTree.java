public class BinaryTree<T> {
    ...
    public static BinaryTree<Integer> fibTree(int N) {
        ...
        BinaryTree<Integer> l = fibTree(N - 1);
        BinaryTree<Integer> r = fibTree(N - 2);
        result.root = new TreeNode<Integer>(l.root.item + r.root.item);
        result.root.setLeft(l.root);
        result.root.setRight(r.root);
        return result;
    }
