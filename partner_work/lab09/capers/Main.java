...
public class Main {
    ...
    public static void writeStory(String[] args) {
        ...
        File story = new File(".capers/story");
        Utils.writeContents(story, Utils.readContents(story), args[1], "\n"); //concatenate vs replace
    ...
    public static void celebrateBirthday(String[] args) {
        ...
        Dog d = Dog.fromFile(String.format(".capers/dogs/%s", args[1]));
        d.haveBirthday();
        d.saveDog();
    }
