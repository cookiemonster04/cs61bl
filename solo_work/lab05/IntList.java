...
public class IntList {
    ...
    public boolean equals(Object obj) {
        ...
        if (next == otherLst.next) return true;
    ...
    public void add(int value) {
        if (next != null) {
            ...
            IntList node = new IntList(value);
            next = node;
        }
    }
    ...
    public int smallest() {
        ...
        return Math.min(item, next.smallest());
    }
     ...
     */
     public static IntList catenate(IntList A, IntList B) {
         if (A == null) return B;
         if (B == null) return A;
         if (A.next != null) return new IntList(A.item, catenate(A.next, B));
         return new IntList(A.item, B);
     }
}